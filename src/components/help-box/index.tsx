...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Health Coach'];
  const customerRoles: string[] = ['Senior User'];
  const tenantRoles: string[] = ['Health Coach', 'Family Member', 'Caregiver', 'Physician'];
  const addOns: string[] = ['chat', 'notifications', 'file'];
  const applicationName = `KratinMedics`;
